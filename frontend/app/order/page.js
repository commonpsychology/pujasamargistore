...
export default function PujaOrderPage() {
  ...
  const handleBooking = async () => {
    ...
    if (!name.trim() || !phone.trim() || !location.trim() || !date) {
      setBookingError('Please fill in name, phone, location, and date.');
      return;
    }
    setBooking(true);
    setBookingError('');
        ...
        <div className="overlay" onClick={e => { if (e.target === e.currentTarget) setSelected(null); }}>
          <div className="modal">
            ...
            <div className="total-row">
              ...
              <div className="total-row-price">₹{total(selected).toLocaleString()}</div>
            </div>
            ...
            <p className="modal-note">Free delivery above ₹499 · Same day available before 2 PM</p>
          </div>
        </div>
      )}
          ...
          <div className="modal booking-modal">
            ...
            {bookingDone ? (
              <div className="booking-success">
                ...
                <p>Your {bookingPuja.name} samagri booking has been received.<br />We will call you at <strong>{bookingForm.phone}</strong> to confirm delivery.</p>
              ...
              <>
                <div className="modal-head">
                  ...
                  <div>
                    <h2 className="modal-title">Book Delivery</h2>
                    <p className="modal-ne">{bookingPuja.name} · ₹{total(bookingPuja).toLocaleString()}</p>
                  </div>
                </div>
