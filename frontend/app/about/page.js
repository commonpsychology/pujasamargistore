...
// app/about/page.js
// Dark gold luxury aesthetic — matches the pooja store dark theme
    ...
    <>
      <style>{`
        ...
        .hero-img-frame {
          ...
          aspect-ratio: 4/3;
          border: 1px solid var(--gold-border);
          box-shadow: 0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(250,204,21,0.06);
        }
        ...
        .hero-img-frame::before {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(160deg, transparent 40%, rgba(8,13,24,0.7));
          z-index: 1;
          pointer-events: none;
        }
