...
// app/payment/page.js
// Auto-fills order details from query params: orderId, total, name, phone, address
        ...
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .success-wrap {
            ...
            background: #080d18; min-height: 100vh;
          ...
          .success-emoji { font-size: 72px; animation: popIn 0.5s cubic-bezier(0.34,1.56,0.64,1) both; }
          .success-title {
            font-family: 'Cormorant Garamond', serif; font-size: 36px; font-weight: 700;
            color: #facc15; margin: 16px 0 8px;
          ...
          .success-ref-label { font-size: 10px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #475569; margin-bottom: 6px; }
          .success-ref-code { font-size: 20px; font-weight: 800; color: #facc15; letter-spacing: 2px; }
          .success-msg {
            color: #64748b; font-size: 13px; line-height: 1.7; margin-bottom: 32px;
          ...
          .home-btn:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(250,204,21,0.25); }
        `}</style>
        <div className="success-wrap">
          <div className="success-card">
            ...
            <div className="success-ref">
              <div className="success-ref-label">Payment Reference</div>
              <div className="success-ref-code">{paymentCode}</div>
            </div>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          --gold: #facc15; --bg: #080d18; --surface: #0c1220;
        ...
        .pay-page {
          ...
          min-height: 100vh; padding: 48px 24px 100px;
          max-width: 600px; margin: 0 auto;
        }

        /* Header */
        .pay-header { margin-bottom: 36px; animation: fadeUp 0.35s ease both; }
        .pay-eyebrow { font-size: 10px; font-weight: 800; letter-spacing: 3px; text-transform: uppercase; color: var(--gold); margin-bottom: 6px; }
        .pay-title { font-family: 'Cormorant Garamond', serif; font-size: 38px; font-weight: 700; color: var(--text); line-height: 1.1; }
        ...
        .od-value.highlight { color: var(--gold); font-size: 15px; font-weight: 900; }
        ...
        .pc-code { font-size: 16px; font-weight: 900; color: var(--gold); letter-spacing: 2px; }
        .copy-btn {
        ...
        .copy-btn.copied { background: rgba(34,197,94,0.1); border-color: rgba(34,197,94,0.25); color: #22c55e; }

        /* Method selector */
        .section-label { font-size: 10px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #334155; margin-bottom: 12px; }
        .methods { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 20px; animation: fadeUp 0.35s 0.1s ease both; }
        @media (max-width: 480px) { .methods { grid-template-columns: repeat(2, 1fr); } }

        .method-btn {
          background: #0c1220; border: 1.5px solid var(--border2);
        ...
        .method-btn.active {
          ...
          background: rgba(var(--method-rgb), 0.07);
          transform: translateY(-2px);
          box-shadow: 0 6px 20px rgba(var(--method-rgb), 0.15);
        }
        .method-emoji { font-size: 24px; line-height: 1; }
        .method-label { font-size: 11px; font-weight: 800; color: #64748b; }
        .method-btn.active .method-label { color: var(--method-color); }
        ...
        .app-link {
          ...
          padding: 7px 16px; border-radius: 999px; margin-top: 14px;
        ...
        .cod-text { color: #94a3b8; font-size: 14px; line-height: 1.8; }
        ...
        .amount-value { color: var(--gold); font-size: 22px; font-weight: 900; }
        ...
        <div className="methods">
          {METHODS.map(m => (
            <button
              ...
              style={{ '--method-color': m.color, '--method-rgb': m.rgb }}
          ...
          {selected === 'esewa' && (
            <>
              ...
              <div className="pay-id-row">
                ...
                <button
                  className={`copy-btn${copied === 'esewa' ? ' copied' : ''}`}
          ...
          {selected === 'khalti' && (
            <>
              ...
              <div className="pay-id-row">
                ...
                <button
                  className={`copy-btn${copied === 'khalti' ? ' copied' : ''}`}
